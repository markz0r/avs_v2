<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Update the connection parameters for the database in the <code>avs_v2.db.schema</code> namespace of your application.
...
Two middleware functions are provided by default in the `avs_v2.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `avs_v2.handler` namespace to manage the enabled middleware.
